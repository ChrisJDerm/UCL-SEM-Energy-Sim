...
v = 6.66667; %nominal race speed in m/s %TODO
massCar = 38; %mass of car in kg %TODO
massDriver = 50; %mass of driver in kg %TODO
g = 9.807; %acceleration of gravity %TODO
...
kittyData = readtable("KittyLaps.xlsx");
